...
namespace WinFormsApplication
{
    public partial class FrmUniversityManageStudentList : Form
    {
                    ...
                    case "Credit":
                        ...
                        else
                        {
                            if (int.TryParse(TxtSearchStudentFollowingFilter.Text, out int credit))
                            {
                                ...
                                {
                                    MessageBox.Show("Credit must be of range (68-200", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                                }
                                else
                                {
                            ...
                            {
                                MessageBox.Show("Credit is Number", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                            }
                        }
                        break;
                }
        ...
        private void FrmUniversityManageStudentList_FormClosing(object sender, FormClosingEventArgs e)
        {
            //DialogResult rs = MessageBox.Show("Are you sure that you want to eixt?", "Manage student information " +
